  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span>Lamido CarsMOBILE © {new Date().getFullYear()}</span>
...
export function RichTextEditor({ initialData, onSave, onBack }: RichTextEditorProps) {
  ...
  const addCoverPage = () => {
    const cover: PageItem = {
      content: `<h1 style="font-size:3rem;font-weight:900;margin-bottom:1rem;">Lamido CarsMOBILE</h1><p style="font-size:1.2rem;color:#64748b;">Document Title</p><p style="margin-top:2rem;font-size:0.9rem;">${new Date().toLocaleDateString()}</p>`,
        ...
        <div style="display:flex;align-items:center;justify-content:flex-start;padding-bottom:16px;margin-bottom:24px;border-bottom:1px solid #e2e8f0;">
          ...
          <div style="flex:1;display:flex;flex-direction:column;align-items:flex-start;">
            ...
            <div style="margin-top:6px;width:100%;text-align:left;">
              ...
              <p style="font-family:Arial,sans-serif;font-size:13px;font-weight:bold;margin:2px 0;color:#000;">Email: <span style="color:#3682be;text-decoration:underline;font-style:italic;font-weight:normal;">Lamidoautomobile@gmail.com</span></p>
            </div>
          </div>
        </div>`;
      ...
      const pagesHTML = pages.map((page, i) => {
        ...
        const footerHTML = `
          <div style="position:relative;z-index:10;margin-top:24px;padding-top:10px;border-top:1px solid #f1f5f9;
            ...
            <span>Lamido CarsMOBILE &copy; ${new Date().getFullYear()}</span>
